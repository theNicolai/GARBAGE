/*
  This script is compatible with UNO_v9_clean
...
// DER SKAL SKRIVES HVOR DETTE ER FRA CA
// MÅSKE : Kursus_dag4_øvelser_v1
...
// Build upon this code: http://web-files.ait.dtu.dk/mnpe/WiFiWebServer_LED.txt
