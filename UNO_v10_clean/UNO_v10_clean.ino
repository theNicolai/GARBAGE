...
boolean DoorOpen = true; // initialise door to be open
...
void loop()
{
  ...
  delay(1000); // Slow send rate down, to allow the NodeMCU to keep up.
...
////////////////////////////
//  Takes full, converts to an int. (roundup)
...
boolean DoorStatus() {
  ...
  return DoorOpen; // Return a boolean used to deside weather to read from ultrasonic ranger or not.
}
